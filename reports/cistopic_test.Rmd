...
```{r loading}
## paths
mtxDir <- "../data/chenS2019sameCellsData/GSE126074_AdBrainCortex_SNAREseq_chromatin.counts.mtx"
barcodesDir <- "../data/chenS2019sameCellsData/GSE126074_AdBrainCortex_SNAREseq_chromatin.barcodes.tsv"
peaksDir <- "../data/chenS2019sameCellsData/GSE126074_AdBrainCortex_SNAREseq_chromatin.peaks.tsv"
...
Ad.chromatin.tsne$Ident=as.character(Ad.metadata.df[rownames(Ad.chromatin.tsne),"Ident"])
```
...
umap.df$'Ident' <- Ad.chromatin.tsne$Ident
umap.df %>%
        filter(Ident != 'Mis') %>%
