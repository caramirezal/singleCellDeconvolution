...
rna.norm.mat <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/rnaseq.RDS")
rna.annotation <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/rna_annotation.RDS")
...
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
# read normalized matrix
atac.norm.mat <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/atacseq.RDS")
atac.annotation <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/rna_annotation.RDS")
...
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
# read normalized matrix
int.norm.mat <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/multiview.RDS")
int.annotation <- readRDS("../mynewdir/sc/singleCellDeconvolution/data/NMF/input/rna_annotation.RDS")
