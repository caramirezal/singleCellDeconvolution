...
```{r umap_satsne}
tsneX <- satsne_annealing (X10 = rna_umap, X20 = atac_umap, 
                           X1shared = shared, X2shared = shared,
...
```{r cistopic_satsne}
cistopic_output <- readRDS('../data/cell_lines_cistopic.RDS')
cistopic.m <- as.matrix(cistopic_output[, 1:2])
tsneX <- satsne_annealing (X10 = rna_umap, X20 = cistopic.m, 
                           X1shared = shared, X2shared = shared,
                           labels1=cell_type$Ident, 
                           labels2=cell_type$Ident,
                           nk1=nk1, nk2=nk2, 
...
Multiview [documentation](http://b2slab.upc.edu/wp-content/uploads/2017/07/mv-vignette.html#multiview-clustering) and github [repository](https://github.com/b2slab/multiview).
